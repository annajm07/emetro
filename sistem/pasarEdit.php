...
$crudpasar = new crudpasar($db_con);
	...
	if (isset($_REQUEST['id'])) {
		...
		<form id="edit-form" method="post" class="form-horizontal" action="<?php echo $urlweb;?>sistem.php?sistem=pasar&act=view&id=<?php print($_REQUEST['id']); ?>">

			<div class="box-body">

				<div class="form-group">
						<label class="col-lg-4 control-label" for="nama">Nama Pasar</label>
						<div class="col-lg-7">
